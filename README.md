...
- End of quiz 3 coverage.
- I found quiz 3 to be the easiest.

## Week 13
- This is the last week of DISMATH lecture class.
- These topics will surely be part of finals according to sir Cabatuan.
- I find these topics easier than proving and algorithms.
- I am more fond of visual intelligence.
- I will apply these into my dismath project such as the vending machine.
- **Graph Coloring**
